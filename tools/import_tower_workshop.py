...
ROWS = [
    ...
    ("health", "Health", "NUMBER", "defense", "defense_start", "flat", "The Number every run starts with.", 1.0),
    ("health_regen", "Health Regen", "NUMBER REGEN", "defense", "defense_start", "per_second", "Number regained every second of a run.", 1.0),
