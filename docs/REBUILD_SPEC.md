...
- **The Number is the tower (D080–D082): built, not yet played by the owner.**
  - The Number sits in the centre, whole, with a ring for how full it is against its ceiling (Health, now reading as Number).
  - The Tower's enemies subtract, shown as "−x".
  - A new Divider takes half the Number on contact ("÷2") and is used up. It comes from wave 5, on top of The Tower's enemies, with its health ramping from 2× to 4×.
  - Measured, The Tower's benchmarks and career pace are unchanged, and about a third of Dividers get through, one every 6 minutes or so in the middle waves.
