...
**Status:** Proposed, 23 September 2026. Nothing here is accepted or built. It follows the owner's direction that the Workshop should be fleshed out rather than cut, and that the difficulty curve should be solved by investment in it. Each row below needs its decision recorded in [`DECISIONS.md`](DECISIONS.md) before it is built.
