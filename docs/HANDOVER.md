...
4. **Waiting on the owner:** whether to accept the proposed set (Burst splashes the pile, Multishot strikes a second enemy, Boss Damage and Leech only on the boss) and how strong Thorns should be. Nothing is built until they say.
