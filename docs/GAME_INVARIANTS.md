...
- Tap Damage and Damage per Second run to 6,000 ranks and Guard to 5,000 (D047). Ranks 1–100 keep their step, so an owned rank never loses value; past 100 a rank is worth more along the row's depth curve, and past rank 100 its price grows at the row's deep rate. A Workshop multi-buy quotes exactly the ranks and price that single presses would.
