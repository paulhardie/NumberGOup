...
- An ordinary wave is a group (D057): 3 members at wave 1, one more every 11 waves, at most 20; a boss is one. Members share the wave's HP and Hit evenly, so their totals are the wave's. Damage strikes the front living member (members at the Number first, carried ones first of all), and what passes its HP is lost. Members arrive in order, the front at 6 seconds and the last at 15, evenly spaced. A member that reaches the Number lands its share of the Hit, heated up 4% for every hit it has already landed, after Armor and then Guard on that one enemy's hit (D063), then stays and hits again until beaten (D058): to wave 30 it instead hits once and leaves, its HP uncleared (D059); from wave 31 it stays, hitting every 15 seconds and easing to `MEMBER_HIT_SECONDS` (5) by wave 50. An ordinary wave whose own members are all beaten, before or after landing, counts as beaten after the minimum beat; one with a member alive when its 15-second clock runs out passes, paying for the share cleared, and its living members carry into the next wave, in front. Waves keep coming while a boss stands (D063): a boss reaches the Number at 15 seconds and hits like one ordinary enemy of its wave, every 15 seconds through the opening and on its wave's clock after; unbeaten when its clock runs out, it passes, paying for the share cleared, and stays at the Number in front of the next wave, hitting on its own clock. Boss Damage and Leech work on the boss itself, in its wave or carried, never on the pile in front of it. A Brace blocks every hit, the pile's included, until the wave's clock ends. A save written under D059 resumes each member's HP, state and clock exactly; an older D058 V10 active save is reconciled to the D059 opening on load (D060).
...
- Collection is an absolute value deducted from Number, a member's share at a time: when it reaches the Number and at every hit after while it stays (D057, D058); a boss's likewise, on its own clock, until beaten (D063). An ordinary wave still standing when its clock runs out moves on, paying its Coins times the share of its own HP cleared (floored) and setting no record or Gem (a checkpoint it carried pays once a later wave is beaten). Number reaching zero ends and resets the run, unless an unspent Second Wind restores a share of the run's peak Number, which it may do at most once per run (D020).
...
- Tier 1 runs one set of rules from wave 1 (D040): Wave HP = 4 × (0.05 w^2.13 + 0.8 w + 1.5) with the milestone steps; the Hit is the wave's HP divided by a ratio on The Tower's shape that grows with the wave, about 2.4 at wave 1, 11 at 100, 118 at 500 and 1,480 at 1,000, so enemies grow tankier than they hit (D063, `TaxBalanceProfile.hit_ratio_log10`); a boss is ×3 HP and hits like one ordinary enemy of its wave (D063); Coins are 0.65 × the wave, ×5 on a boss. Below wave 100, no ordinary wave's HP or Hit is more than 1.6× the ordinary wave before it; the ×1.5 milestone at wave 100 is the deliberate tier gate. A run saved under an older balance profile resumes with its active wave rebuilt on the current curve, keeping the share already cleared. A Tier 1 run starts with 50 Number. Doing nothing, including no Rig purchases, must end, and must earn clearly less than tapping once a second (under three quarters of its Coins).
...
- Brace spends 30% of current Number, less whatever Brace Cost has bought, never below a 15% floor, and blocks every hit until the wave's clock ends, the pile's and any boss's included (D057, D058, D063). A blocked Hit deals no Thorns, because no hit landed (D038).
