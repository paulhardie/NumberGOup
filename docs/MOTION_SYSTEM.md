...
| --- | --- | --- |
| A tap with Liability left | A mote leaves the Number for the wave at once and the Number pulses; as it lands (0.32 s) the wave's HP drops and its damage updates one fixed readout beside the struck member (D061). Passive damage still sends one mote per shot (2.5 a second before Attack Speed, D055); Multishot sends two, the second 0.08 s behind (D054). The readout combines damage for 0.5 s, marks critical damage as "CRIT", and rests after 0.8 s without a hit. Between waves a tap's gain floats up as "+X", as before. | No motes; the shown HP and readout update when passive damage is collected every 0.33 s. Number pulse skipped. |
