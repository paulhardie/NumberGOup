...
| --- | --- | --- |
| A tap with Liability left | A mote leaves the Number for the wave at once and the Number pulses; as it lands (0.32 s) the wave's HP drops and its damage rises off the wave as "-X". Passive damage goes as one mote per shot (2.5 a second before Attack Speed, D055); a Multishot sends two, the second 0.08 s behind (D054). Shots' damage rises off the wave as one smaller "-X" every 0.33 s, "CRIT" if any shot in it crit. Between waves a tap's gain floats up as "+X", as before. | No motes; the HP drops and the "-X" shows on the wave at once, passive damage as one "-X" every 0.33 s. Number pulse skipped. |
