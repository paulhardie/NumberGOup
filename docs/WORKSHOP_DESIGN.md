...
## The Workshop since D068: The Tower's

*Added 25 September 2026.* On owner direction the Workshop is now The Tower's own ([D068](DECISIONS.md#d068--the-towers-workshop-in-full-around-the-number)). The sections below on the Attack, Defense and Utility rows, the deep ladders (D019, D047), first-build prices (D035), what Defense is worth, the Rig's income pricing (D039) and its measured targets are **history**: they describe rows and prices that no longer exist. The wave rule, the vocabulary, the four categories, what the player sees and the strategies still hold.

- **Rows and numbers.** The Tower's 34 rows, every level's value, Coin price and Cash price in `data/workshop/upgrades.json`, generated by `tools/import_tower_workshop.py` from TheTowerSDK's table. `current.md` beside it is the readable summary.
- **Unlocks.** Each category opens a group at a time, in The Tower's order, for Coins between runs:

  | Category | Open from the start | Then, in order (Coins) |
  |---|---|---|
  | Attack | Damage, Attack Speed, Critical Chance, Critical Factor | Range + Damage / Meter (50) · Multishot Chance + Targets (400) · Rapid Fire Chance + Duration (1,500) · Bounce Shot Chance + Targets + Range (10,000) · Super Crit Chance + Mult (100M) |
  | Defense | Health, Health Regen | Defense % + Defense Absolute (75) · Thorn Damage (500) · Lifesteal (2,000) · Knockback Chance + Force (5,000) · Orb Speed + Orbs (15,000) · Death Defy (1.5M) |
  | Utility | nothing | Cash Bonus + Cash / Wave (40) · Coins / Kill Bonus + Coins / Wave (100) · Free Attack, Defense and Utility Upgrade (800) · Interest / Wave (5,000) |
